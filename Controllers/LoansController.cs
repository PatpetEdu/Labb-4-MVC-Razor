...
namespace Labb_4___MVC___Razor.Controllers
{
    public class LoansController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("LoanId,FkCustomerId,FkBookId,LoanDate,ReturnDate")] Loan loan)
        {
            ...
            ViewData["FkBookId"] = new SelectList(_context.Books, "BookId", "Author", loan.FkBookId);
            ViewData["FkCustomerId"] = new SelectList(_context.Customers, "CustomerId", "CustomerName", loan.FkCustomerId);
            return View(loan);
        }
